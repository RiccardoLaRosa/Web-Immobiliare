<x-layout>
        ...
        <div class="container position-relative" style="z-index: 1;">
            <div class="row align-items-center g-5">
                <div class="col-lg-8">
                    ...
                    {{-- Badge --}}
                    <div class="d-inline-flex align-items-center gap-2 px-3 py-2 rounded-pill mb-4 mt-5"
    ...
    {{-- Statistiche di Mercato --}}
    <section
        style="padding: 60px 0; border-top: 1px solid var(--border-glass); border-bottom: 1px solid var(--border-glass); background: rgba(255,255,255,0.01);"
        class="container">
        <div class="container">
            ...
            <div class="crystal-ux-card rounded-5 p-3 position-relative overflow-hidden w-100" style="height: 420px;">
                <div class="w-100 h-100 rounded-4 overflow-hidden position-relative"
                    ...
                    <iframe src="https://maps.google.com/maps?q=Milano&t=&z=13&ie=UTF8&iwloc=&output=embed"
                        width="100%" height="100%" frameborder="0" style="border:0; mix-blend-mode: multiply;"
                        allowfullscreen></iframe>

                    <div class="position-absolute bottom-0 start-0 m-4 p-3 rounded-4 d-none d-sm-block"
                        ...
                        <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <span style="font-size: 0.7rem; font-weight: 700; color: var(--text-dark-main);"
                                class="tracking-wider">Focus Area: Milano</span>
                        </div>
            ...
            <div class="mb-4 text-center text-md-start">
                <div class="d-inline-flex align-items-center gap-2 px-3 py-1.5 rounded-pill mb-4 mt-5"
                    ...
                    <span style="width: 6px; height: 6px; background: var(--neon-emerald); display: inline-block;"
                        class="rounded-circle animate-pulse"></span>
                    <span
                        style="font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.15em; color: var(--text-muted); font-weight: 600;">Global
                        Feedback</span>
                </div>
                <h3 class="text-white fw-bold m-0" style="letter-spacing: -0.5px;">Cosa dicono i nostri Partner</h3>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="p-4 rounded-4"
                        ...
                        <div class="d-flex align-items-center gap-2 mb-3">
                            <span style="color: var(--neon-emerald);"><i class="ti ti-star-filled"></i><i
                                    class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i
                                    class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i></span>
                            <span class="text-white opacity-30 small font-monospace">| VERIFIED LUXURY PARTNER</span>
                        </div>
                        <p class="text-white opacity-70 small lh-base italic">"La sezione dei dati analitici mi ha
                            permesso di capire esattamente quando posizionare il mio attico a Milano sul mercato.
                            Trattativa chiusa in meno di 20 giorni."</p>
                        <span class="text-white fw-semibold d-block mt-3" style="font-size: 0.85rem;">Massimiliano B.
                            <span class="opacity-40 fw-normal">— Investor</span></span>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="p-4 rounded-4"
                        style="background: rgba(255,255,255,0.01); border: 1px solid rgba(255,255,255,0.03);">
                        <div class="d-flex align-items-center gap-2 mb-3">
                            <span style="color: var(--neon-cyan);"><i class="ti ti-star-filled"></i><i
                                    class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i
                                    class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i></span>
                            <span class="text-white opacity-30 small font-monospace">| ARCHITECTURE LOVER</span>
                        </div>
                        <p class="text-white opacity-70 small lh-base italic">"Esperienza utente incredibile. I
                            rendering immersivi e la trasparenza dei dati sui prezzi al metro quadro non si trovano su
                            nessun altro portale immobiliare."</p>
                        <span class="text-white fw-semibold d-block mt-3" style="font-size: 0.85rem;">Elena R. <span
                                class="opacity-40 fw-normal">— Designer & Buyer</span></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container position-relative" style="z-index: 1;">
            <div class="d-flex justify-content-between align-items-end mb-5">
                ...
                <div class="d-none d-md-block">
                    <a href="{{ route('properties.index') }}" class="btn px-4 py-2 rounded-pill fw-semibold"
                            ...
                            <div class="glass-ux-card rounded-5 h-100 d-flex flex-column overflow-hidden p-3">
                                <div class="position-relative overflow-hidden rounded-4" style="height: 250px;">
                                    ...
                                    <div class="position-absolute top-0 start-0 m-3">
                                        @if ($property->status == 'Disponibile')
                                            <span class="badge rounded-pill px-3 py-1.5 text-white"
                                                style="background: rgba(0, 245, 159, 0.836); color: var(--neon-emerald); border: 1px solid rgba(0, 245, 160, 0.3); font-size: 11px; font-weight: 700; letter-spacing: 0.05em;">
                                                LIVE NOW
                                            </span>
                                        @else
                                            <span class="badge rounded-pill px-3 py-1.5 text-white"
                                                style="background: rgba(219, 9, 9, 0.801); color: var(--text-muted); border: 1px solid var(--border-glass); font-size: 11px;">
                                                RISERVATO
                                            </span>
                                        @endif
                                    </div>
                                ...
                                <div class="p-3 d-flex flex-column flex-grow-1 mt-2">
                                    ...
                                    <div class="mt-auto pt-3" style="border-top: 1px solid rgba(255,255,255,0.04);">
                                        <div class="btn w-100 d-flex align-items-center justify-content-center gap-2 py-2.5 rounded-4 font-semibold text-decoration-none"
