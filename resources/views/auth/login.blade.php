<x-layout>
    <div class=" container-fluid  h-100 p-0" style= "margin-top: 200px; margin-bottom: 220px">
        <div class="d-flex flex-column justify-content-center align-items-center mt-5 ">
            ...
            <form action="{{ route('login.store') }}" method="POST" class="ms-3 mt-3 col-3">
                @csrf
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label"><span
                            class="fs-5 fw-semibold">Email</span></label>
                ...
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label"><span
                            class="fs-5 fw-semibold">Password</span></label>
                    ...
                    <a href="{{ route('password.request') }}">
                        <h6 class="mt-2">Password Dimenticata</h6>
                    </a>
                </div>
